        ...
        <div className="container items-center my-40 mx-auto p-4">
            <div className="flex flex-col mb-20 gap-y-8 items-start">
                ...
                <div className="flex items-center space-x-6 md:space-x-8">
                    <button
                        className="relative flex items-center justify-center w-6 h-6 outline outline-2 outline-foreground hover:outline-green-500 outline-offset-4 ml-10 group">
                    ...
                    <button
                        className="flex items-center justify-center w-6 h-6 outline outline-2 outline-foreground hover:outline-green-500 outline-offset-4 group">
